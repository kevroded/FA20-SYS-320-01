...
# create a prompt that allows the user to sepcify a keyword or phrase to search on
# Find a string from events to search on

$searchPhrase = Read-host -Prompt "Please enter a phrase to search for"
...
-Path "E:\FA20-SYS-320-01\Week08\class\$readLog-log-Custom.csv"